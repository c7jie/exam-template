...
import cn.attachie.exam.common.core.vo.AttachmentVo;
import cn.attachie.exam.common.core.web.BaseController;
import cn.attachie.exam.common.log.annotation.Log;
import cn.attachie.exam.exam.api.dto.KnowledgeDto;
import cn.attachie.exam.exam.api.module.Knowledge;
import cn.attachie.exam.exam.service.KnowledgeService;
...
public class KnowledgeController extends BaseController {
    ...
    public PageInfo<KnowledgeDto> knowledgeList(@RequestParam(value = CommonConstant.PAGE_NUM, required = false, defaultValue = CommonConstant.PAGE_NUM_DEFAULT) String pageNum,
        ...
        // 根据附件ID查询附件
        ResponseBean<List<AttachmentVo>> returnT =
                // todo:
                null;
