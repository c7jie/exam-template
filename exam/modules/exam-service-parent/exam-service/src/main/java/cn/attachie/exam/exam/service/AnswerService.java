package cn.attachie.exam.exam.service;

import cn.attachie.exam.common.core.constant.CommonConstant;
import cn.attachie.exam.common.core.constant.MqConstant;
...
import cn.attachie.exam.common.core.utils.PageUtil;
...
import cn.attachie.exam.exam.api.constants.AnswerConstant;
import cn.attachie.exam.exam.api.dto.AnswerDto;
import cn.attachie.exam.exam.api.dto.RankInfoDto;
import cn.attachie.exam.exam.api.dto.StartExamDto;
import cn.attachie.exam.exam.api.dto.SubjectDto;
import cn.attachie.exam.exam.api.enums.SubmitStatusEnum;
...
import cn.attachie.exam.exam.api.module.ExaminationSubject;
import cn.attachie.exam.exam.enums.SubjectTypeEnum;
import cn.attachie.exam.exam.handler.AnswerHandleResult;
import cn.attachie.exam.exam.handler.impl.ChoicesAnswerHandler;
import cn.attachie.exam.exam.handler.impl.JudgementAnswerHandler;
import cn.attachie.exam.exam.handler.impl.MultipleChoicesAnswerHandler;
import cn.attachie.exam.exam.handler.impl.ShortAnswerHandler;
import cn.attachie.exam.exam.mapper.AnswerMapper;
import cn.attachie.exam.exam.utils.AnswerHandlerUtil;
import cn.attachie.exam.exam.utils.ExamRecordUtil;
...
public class AnswerService extends CrudService<AnswerMapper, Answer> {
    ...
    public AnswerDto answerInfo(Long recordId, Long currentSubjectId, Integer nextSubjectType, Integer nextType) {
        ...
        ResponseBean<List<UserVo>> userVoResponseBean =
                null;
                // Todo:
                //userServiceClient.findUserById(new Long[]{record.getUserId()});
    ...
    public List<RankInfoDto> getRankInfo(Long recordId) {
        ...
        if (typedTuples != null) {
            ...
            if (!userIds.isEmpty()) {
                ResponseBean<List<UserVo>> userResponse =
                        // todo:
                        null;
                        //userServiceClient.findUserById(userIds.toArray(new Long[0]));
