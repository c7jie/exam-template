...
import cn.attachie.exam.auth.error.CustomOAuth2AccessDeniedHandler;
import cn.attachie.exam.auth.security.CustomUserDetailsAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling()
                .accessDeniedHandler(accessOAuthDeniedHandler());
    }
    ...
    @Bean
    public AccessDeniedHandler accessOAuthDeniedHandler() {
