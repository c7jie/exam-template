package cn.attachie.exam.common.log.aspect;
...
import cn.attachie.exam.common.log.event.LogEvent;
import cn.attachie.exam.common.log.utils.LogUtil;
...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint point, Log log) throws Throwable {
        ...
        cn.attachie.exam.common.core.model.Log logVo = LogUtil.getLog();
